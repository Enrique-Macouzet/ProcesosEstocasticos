...
Página temporal para el método de Aproximaciones Sucesivas.
"""
...
<div style="margin-bottom:1.5rem;">
    ...
    <p style="color:#8FA0B8;font-size:.9rem;margin:.4rem 0 0 0;">Iteración de valores para encontrar la política óptima.</p>
</div>
""", unsafe_allow_html=True)

st.info("🚧 Este módulo está en desarrollo y estará disponible próximamente.")
