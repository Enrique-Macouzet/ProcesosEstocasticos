...
Página temporal para la exportación a Excel.
"""
...
<div style="margin-bottom:1.5rem;">
    ...
    <p style="color:#8FA0B8;font-size:.9rem;margin:.4rem 0 0 0;">Descarga el modelo y las soluciones en un libro de Excel.</p>
</div>
